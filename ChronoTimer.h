...
class ChronoTimer
{
 ...
 public:
  ...
  ChronoTimer(bool start_on_create = false);             // ctor
  ChronoTimer(const ChronoTimer &) = default;            // default copy ctor
  ChronoTimer& operator=(const ChronoTimer &) = default; // default copy operator
  ~ChronoTimer() = default;                              // default dtor
 ...
 private:
  ...
  size_t                 m_weight;           // weight for meantime computation
};  // class ChronoTimer

/*---------------------------------------------------------------------------*/
/*---------------------------------------------------------------------------*/

#endif /* _CHRONO_TIMER_H_ */
